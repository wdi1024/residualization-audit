...
cache = "/tmp/wikiqa_stsb_s_8000.npy"
if os.path.exists(cache):
    s = np.load(cache)
    print("loaded cached scores")
else:
    from sentence_transformers import CrossEncoder
    ce = CrossEncoder("cross-encoder/stsb-roberta-base", max_length=256)
...
out = {"scorer": "cross-encoder/stsb-roberta-base",
       "C2_R2_phi_to_s": r2,
...
dst = os.path.join(os.path.dirname(__file__),
                   "../notes/wikiqa_stsb_2026-07-11.json")
